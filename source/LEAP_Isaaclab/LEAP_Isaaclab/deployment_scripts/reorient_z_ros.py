...
def main():
    ...
    parser = argparse.ArgumentParser(description="Deploy a LEAP Hand reorientation policy through ROS2.")
    ...
    agent = HardwarePlayer(cfg_path=args.cfg, ckpt_path=args.checkpoint)
    agent.restore()
